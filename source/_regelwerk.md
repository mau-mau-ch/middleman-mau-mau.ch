...
## § 9. b Königsgelage
Auf das spielen eines Königs kann sofort ein weiterer König (oder auch eine 10) von ei nem beliebigen Spieler eingeworfen werden. Dies ist nur so lange möglich so lange ein König anspielbar ist oder der dem Uhrzeigersinn folgende Spieler noch nicht von seinem Spielrecht gebrauch gemacht hat.
